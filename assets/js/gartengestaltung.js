...
class Component extends DCLogic {
  ...
  componentDidMount() {
    ...
    if (form) form.addEventListener('submit', e => {
      ...
      const mailto = () => {
        window.location.href = 'mailto:' + ((window.dvFormular && window.dvFormular.empfaenger) || 'info@devries-galabau.de') + '?subject=' + encodeURIComponent('Anfrage Gartengestaltung') + '&body=' + encodeURIComponent(body);
      };
