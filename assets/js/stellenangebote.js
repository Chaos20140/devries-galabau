...
class Component extends DCLogic {
  ...
  componentDidMount() {
    ...
    if (form) form.addEventListener('submit', e => {
      ...
      window.location.href = 'mailto:' + ((window.dvFormular && window.dvFormular.empfaenger) || 'info@devries-galabau.de') + '?subject=' + encodeURIComponent('Bewerbung') + '&body=' + encodeURIComponent(body);
    });
  }
